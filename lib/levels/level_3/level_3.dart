...
import 'package:flutter_slider_puzzle/levels/level_3/background.dart';

import '../../title_screen.dart';

class Level3 extends FlameGame with HasCollidables, HasDraggables {
  Level3({required this.checkWin});
  CheckWin checkWin;
